...
// CmsCase is the golang structure for table cms_case.
type CmsCase struct {
	Id         uint64 `json:"id"         orm:"id"          description:"案例ID"`               // 案例ID
	CategoryId uint64 `json:"categoryId" orm:"category_id" description:"分类ID"`               // 分类ID
	Title      string `json:"title"      orm:"title"       description:"案例标题"`               // 案例标题
	Cover      string `json:"cover"      orm:"cover"       description:"封面图"`                // 封面图
	Summary    string `json:"summary"    orm:"summary"     description:"摘要"`                 // 摘要
	Content    string `json:"content"    orm:"content"     description:"案例详情(Markdown)"`     // 案例详情(Markdown)
