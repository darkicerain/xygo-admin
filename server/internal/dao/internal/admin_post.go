...
// AdminPostDao is the data access object for the table xy_admin_post.
...
// AdminPostColumns defines and stores column names for the table xy_admin_post.
...
// adminPostColumns holds the columns for the table xy_admin_post.
