...
// AdminNoticeDao is the data access object for the table xy_admin_notice.
...
// AdminNoticeColumns defines and stores column names for the table xy_admin_notice.
type AdminNoticeColumns struct {
	Id         string // 主键
	Title      string // 标题
	Type       string // 类型:1=通知,2=公告,3=私信
	Content    string // 内容(HTML)
	Tag        string // 标签(info/success/warning/danger)
	SenderId   string // 发送人ID(0=系统)
	ReceiverId string // 接收人ID(0=全员)
	Status     string // 状态:1=正常,2=关闭
	Sort       string // 排序
	Remark     string // 备注
	ReadCount  string // 已读人数
	CreatedAt  string // 创建时间
	UpdatedAt  string // 更新时间
}

// adminNoticeColumns holds the columns for the table xy_admin_notice.
