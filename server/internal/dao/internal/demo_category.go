...
// DemoCategoryDao is the data access object for the table xy_demo_category.
...
// DemoCategoryColumns defines and stores column names for the table xy_demo_category.
...
// demoCategoryColumns holds the columns for the table xy_demo_category.
