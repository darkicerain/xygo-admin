...
// AdminNoticeReadDao is the data access object for the table xy_admin_notice_read.
...
// AdminNoticeReadColumns defines and stores column names for the table xy_admin_notice_read.
...
// adminNoticeReadColumns holds the columns for the table xy_admin_notice_read.
